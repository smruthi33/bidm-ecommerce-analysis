...
* Project Path: ~;
* Project Name: Instacart;
* Diagram Id: EMWS1;
* Diagram Name: Association;
* Generated by: u49655256;
* Date: 16OCT2020:13:05:12;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
%let EM_PROJECTNAME =;
%let EM_WSNAME =;
%let EM_WSDESCRIPTION =Association;
...
filename dspath "&dspath";
file dspath;
put 'if NAME="product_name" then do;';
put 'ROLE="TARGET";';
put 'LEVEL="NOMINAL";';
put 'ORDER="";';
put 'DROP="N";';
...
id= "FIMPORT";
property="IFileName";
value= "C:\PALLAVRAJ\CMU\FALL 2020\BIDM\Project\files\market_basket_train.csv";
output;
id= "FIMPORT";
